                    ...
                    <div>
                        <form>
							...
							<Select options={Companies.map((item) => { return { value: item, label: item } })}
								...
								isDisabled={selectedIndustry ? false : true} className="mb-3" />
							<Select options={Years.map((item) => { return { value: item, label: item } })}
								placeholder='year'
								onChange={handleYearChange}
								value={selectedYear}
								isDisabled={selectedCompany ? false : true} className="mb-3" />
							<Button variant="contained" size="medium" id="CompanySelectingConfirm" style={{ marginTop: '10px' }} onClick={handleCompanySelectingConfirm} disabled={selectedYear && selectedCompany && selectedIndustry ? false : true}>Confirm</Button>
                        </form>
                    </div>
                </div>
            </div>
