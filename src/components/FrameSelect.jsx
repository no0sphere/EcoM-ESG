...
const FrameSelect = () => {
  const validateCustomFrameworkData = (data, type = "Create") => {
    ...
    // length of name should in 5 to 16
      ...
      type === "Create" &&
      (data.framework_name.length < 5 || data.framework_name.length > 16)
    ) {
      setCustomError(
        "The length of the frame name should be between 5 and 16!"
      );
      console.log(
        "The length of the frame name should be between 5 and 16!" +
          data.framework_name
            ...
            >
              <div className="card-body">
                ...
                <p className="card-text">
                  Creation Date: {framework.update_time}
                </p>
            ...
            <div style={{ overflow: "auto", height: "90%" }}>
              ...
              >
                ...
                <p style={{ marginBottom: "40px", display: "flex" }}>
                  Creation Date: {currentFramework.update_time}
                </p>
                <List
                  sx={{
                    width: "80%",
